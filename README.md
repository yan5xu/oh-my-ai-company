...
| 类型 | 数量 | 说明 |
| --- | ---: | --- |
| 公司/产品 | 75 | AI 应用、企业 Agent、browser/agent infra、垂直 AI、开发者工具等 |
| 投资人/投资机构 | 75 | VC、战略投资方、天使投资人、创业者投资人 |
| 人物 | 111 | 创始人、CEO、投资人、记者、关键 operator |
| 持续触点 | 227 | 官网、博客、X、LinkedIn、Product Hunt、GitHub、文档、媒体页等 |
...
- **Browser / Agent Infra / 自动化执行**：Browserbase、Browserless、Hyperbrowser、Browser Use、StableBrowse、Arga Labs、Adept、Exa、Temporal、Resolve AI、Reindeer AI。
